...
@class OttuSentryObjCAttachment;
@class OttuSentryObjCBreadcrumb;
@class OttuSentryObjCEvent;
@class OttuSentryObjCFeedbackApi;
@class OttuSentryObjCId;
@class OttuSentryObjCLogger;
@class OttuSentryObjCMetricsApi;
@class OttuSentryObjCOptions;
@class OttuSentryObjCReplayApi;
 ...
 */
@interface OttuSentryObjCSDK : NSObject

/// The current active transaction or span bound to the scope.
@property (class, nonatomic, readonly, nullable) OttuSentryObjCSpan *span;

/// Indicates whether the Sentry SDK is enabled.
@property (class, nonatomic, readonly) BOOL isEnabled;

/// API to access Sentry logs.
@property (class, nonatomic, readonly) OttuSentryObjCLogger *logger;
 ...
 */
@property (class, nonatomic, readonly) OttuSentryObjCLastRunStatus lastRunStatus;
...
@property (class, nonatomic, readonly) OttuSentryObjCFeedbackApi *feedback;
#endif
 ...
 */
+ (void)startWithOptions:(OttuSentryObjCOptions *)options;
 ...
 * SDK starts on the main thread async.
 */
+ (void)startWithConfigureOptions:(void (^)(OttuSentryObjCOptions *))configureOptions;
 ...
 * @return The @c SentryObjCId of the event or an empty ID if the event is not sent.
 */
+ (OttuSentryObjCId *)captureEvent:(OttuSentryObjCEvent *)event withScope:(OttuSentryObjCScope *)scope;
 ...
 */
+ (OttuSentryObjCId *)captureEvent:(OttuSentryObjCEvent *)event
                    withScopeBlock:(void (^)(OttuSentryObjCScope *))block;
 ...
 * @return The @c SentryObjCId of the event or an empty ID if the event is not sent.
 */
+ (OttuSentryObjCId *)captureEvent:(OttuSentryObjCEvent *)event attachAllThreads:(BOOL)attachAllThreads;
 ...
 * @return The @c SentryObjCId of the event or an empty ID if the event is not sent.
 */
+ (OttuSentryObjCId *)captureError:(NSError *)error withScope:(OttuSentryObjCScope *)scope;
 ...
 * @return The @c SentryObjCId of the event or an empty ID if the event is not sent.
 */
+ (OttuSentryObjCId *)captureError:(NSError *)error withScopeBlock:(void (^)(OttuSentryObjCScope *))block;
 ...
 * @return The @c SentryObjCId of the event or an empty ID if the event is not sent.
 */
+ (OttuSentryObjCId *)captureError:(NSError *)error attachAllThreads:(BOOL)attachAllThreads;
 ...
 * @return The @c SentryObjCId of the event or an empty ID if the event is not sent.
 */
+ (OttuSentryObjCId *)captureException:(NSException *)exception withScope:(OttuSentryObjCScope *)scope;
 ...
 * @return The @c SentryObjCId of the event or an empty ID if the event is not sent.
 */
+ (OttuSentryObjCId *)captureException:(NSException *)exception attachAllThreads:(BOOL)attachAllThreads;
 ...
 * @return The @c SentryObjCId of the event or an empty ID if the event is not sent.
 */
+ (OttuSentryObjCId *)captureMessage:(NSString *)message withScope:(OttuSentryObjCScope *)scope;
 ...
 * @return The @c SentryObjCId of the event or an empty ID if the event is not sent.
 */
+ (OttuSentryObjCId *)captureMessage:(NSString *)message attachAllThreads:(BOOL)attachAllThreads;
...
+ (void)captureFeedbackWithMessage:(NSString *)message
                            ...
                            source:(OttuSentryObjCFeedbackSource)source
                 associatedEventId:(nullable OttuSentryObjCId *)associatedEventId
                       attachments:(nullable NSArray<OttuSentryObjCAttachment *> *)attachments;
 ...
 */
+ (void)setUser:(nullable OttuSentryObjCUser *)user;

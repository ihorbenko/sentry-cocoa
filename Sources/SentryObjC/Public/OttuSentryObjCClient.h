 ...
 */
@interface OttuSentryObjCClient : NSObject
SENTRY_NO_INIT
 ...
 */
- (nullable instancetype)initWithOptions:(OttuSentryObjCOptions *)options;

/// Indicates whether the client is enabled and will send events to Sentry.
@property (nonatomic, readonly) BOOL isEnabled;

/// The options used to configure this client.
@property (nonatomic, strong) OttuSentryObjCOptions *options;
 ...
 */
- (void)captureFeedback:(OttuSentryObjCFeedback *)feedback
              withScope:(OttuSentryObjCScope *)scope NS_SWIFT_NAME(capture(feedback:scope:));

...
@interface OttuSentryObjCFeedback : NSObject
SENTRY_NO_INIT
...
@property (nonatomic, readonly) OttuSentryObjCFeedbackSource source;

/// The unique event identifier for this feedback submission.
@property (nonatomic, readonly, strong) OttuSentryObjCId *eventId;

/// The event ID that this feedback is associated with, like a crash report.
@property (nonatomic, readonly, strong, nullable) OttuSentryObjCId *associatedEventId;

/// Attachments for this feedback submission, like a screenshot.
@property (nonatomic, readonly, strong, nullable) NSArray<OttuSentryObjCAttachment *> *attachments;

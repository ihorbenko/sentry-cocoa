 ...
 */
@interface OttuSentryObjCMetricsApi : NSObject
SENTRY_NO_INIT
...
- (void)countWithKey:(NSString *)key
          ...
          attributes:(NSDictionary<NSString *, OttuSentryObjCAttributeContent *> *)attributes;
...
- (void)distributionWithKey:(NSString *)key
                      value:(double)value
                       unit:(nullable OttuSentryObjCUnit *)unit
                 attributes:(NSDictionary<NSString *, OttuSentryObjCAttributeContent *> *)attributes;
 ...
 * @param unit Optional unit of measurement.
 */
- (void)gaugeWithKey:(NSString *)key value:(double)value unit:(nullable OttuSentryObjCUnit *)unit;

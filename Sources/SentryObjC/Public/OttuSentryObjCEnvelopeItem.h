 ...
 */
@interface OttuSentryObjCEnvelopeItem : NSObject
SENTRY_NO_INIT
 ...
 */
- (instancetype)initWithEvent:(OttuSentryObjCEvent *)event;
 ...
 */
- (nullable instancetype)initWithAttachment:(OttuSentryObjCAttachment *)attachment

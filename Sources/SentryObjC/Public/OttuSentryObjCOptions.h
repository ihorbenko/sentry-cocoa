...
@class OttuSentryObjCExperimentalOptions;
@class OttuSentryObjCHttpStatusCodeRange;
@class OttuSentryObjCLog;
@class OttuSentryObjCMetric;
@class OttuSentryObjCReplayOptions;
@class OttuSentryObjCSamplingContext;
...
@interface OttuSentryObjCOptions : NSObject
 ...
 */
@property (nonatomic) OttuSentryObjCLevel diagnosticLevel;
...
@property (nonatomic, copy, nullable) SentryObjCEvent *_Nullable (^beforeSend)(OttuSentryObjCEvent *);

/**
 * Use this callback to drop or modify a span before the SDK sends it to Sentry.
 * Return @c nil to drop the span.
 */
@property (nonatomic, copy, nullable) OttuSentryObjCSpan *_Nullable (^beforeSendSpan)(OttuSentryObjCSpan *);
...
@property (nonatomic, copy, nullable) OttuSentryObjCBreadcrumb *_Nullable (^beforeBreadcrumb)
    (OttuSentryObjCBreadcrumb *);

/// This block can be used to modify or drop a log before it will be sent. Return @c nil to drop the
/// log.
@property (nonatomic, copy, nullable) OttuSentryObjCLog *_Nullable (^beforeSendLog)(OttuSentryObjCLog *);

/// This block can be used to modify or drop a metric before it will be sent. Return @c nil to drop
/// the metric.
@property (nonatomic, copy, nullable) OttuSentryObjCMetric *_Nullable (^beforeSendMetric)
    (OttuSentryObjCMetric *);
 ...
 */
@property (nonatomic, copy, nullable) BOOL (^beforeCaptureScreenshot)(OttuSentryObjCEvent *);
 ...
 * doesn't work for crashes.
 */
@property (nonatomic, copy, nullable) BOOL (^beforeCaptureViewHierarchy)(OttuSentryObjCEvent *);
 ...
 */
@property (nonatomic, copy, nullable) void (^onCrashedLastRun)(OttuSentryObjCEvent *)
...
@property (nonatomic, copy, nullable) void (^onLastRunStatusDetermined)
    (OttuSentryObjCLastRunStatus, OttuSentryObjCEvent *_Nullable);
 ...
 */
@property (nonatomic, copy) OttuSentryObjCScope * (^initialScope)(OttuSentryObjCScope *);
 ...
 */
@property (nonatomic, copy) NSArray<OttuSentryObjCHttpStatusCodeRange *> *failedRequestStatusCodes;
...
@property (nonatomic, strong) OttuSentryObjCExperimentalOptions *experimental;
...
@property (nonatomic, strong) OttuSentryObjCReplayOptions *sessionReplay;

 ...
 */
@interface OttuSentryObjCAttachment : NSObject
SENTRY_NO_INIT
...
@property (nonatomic, readonly) OttuSentryObjCAttachmentType attachmentType;
...
- (instancetype)initWithData:(NSData *)data
                    filename:(NSString *)filename
                 contentType:(nullable NSString *)contentType
              attachmentType:(OttuSentryObjCAttachmentType)attachmentType;

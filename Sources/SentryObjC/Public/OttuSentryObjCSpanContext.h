 ...
 */
@interface OttuSentryObjCSpanContext : NSObject
SENTRY_NO_INIT
...
/// Id of a parent span.
@property (nonatomic, readonly, strong, nullable) OttuSentryObjCSpanId *parentSpanId;
 ...
 */
- (instancetype)initWithOperation:(NSString *)operation sampled:(OttuSentryObjCSampleDecision)sampled;
...
- (instancetype)initWithTraceId:(OttuSentryObjCId *)traceId
                       ...
                       parentId:(nullable OttuSentryObjCSpanId *)parentId

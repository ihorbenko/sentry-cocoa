 ...
 */
@interface OttuSentryObjCEnvelopeHeader : NSObject
SENTRY_NO_INIT
 ...
 * e.g. attachments.
 */
@property (nonatomic, readonly, strong, nullable) OttuSentryObjCId *eventId;
 ...
 */
- (instancetype)initWithId:(nullable OttuSentryObjCId *)eventId
              traceContext:(nullable OttuSentryObjCTraceContext *)traceContext;

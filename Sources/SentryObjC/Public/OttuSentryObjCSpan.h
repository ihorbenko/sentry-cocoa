...
@class OttuSentryObjCMeasurementUnit;
@class OttuSentryObjCSpanId;
@class OttuSentryObjCTraceContext;
@class OttuSentryObjCTraceHeader;
 ...
 */
@interface OttuSentryObjCSpan : NSObject
SENTRY_NO_INIT
...
/// The span id.
@property (nonatomic, strong) OttuSentryObjCSpanId *spanId;

/// The id of the parent span.
@property (nonatomic, strong, nullable) OttuSentryObjCSpanId *parentSpanId;

/// The sampling decision of the trace.
@property (nonatomic) OttuSentryObjCSampleDecision sampled;
...
@property (nonatomic) OttuSentryObjCSpanStatus status;
...
@property (nonatomic, readonly, strong, nullable) OttuSentryObjCTraceContext *traceContext;
 ...
 */
- (OttuSentryObjCSpan *)startChildWithOperation:(NSString *)operation;
...
- (void)setMeasurementWithName:(NSString *)name
                         value:(NSNumber *)value
                          unit:(OttuSentryObjCMeasurementUnit *)unit;
 ...
 */
- (void)finishWithStatus:(OttuSentryObjCSpanStatus)status;

/**
 * Returns the trace information that could be sent as a sentry-trace header.
 * @return The trace header.
 */
- (OttuSentryObjCTraceHeader *)toTraceHeader;

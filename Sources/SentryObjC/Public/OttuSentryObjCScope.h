 ...
 */
@interface OttuSentryObjCScope : NSObject
...
- (void)setLevel:(OttuSentryObjCLevel)level;
 ...
 */
- (void)addAttachment:(OttuSentryObjCAttachment *)attachment;
...
@property (nullable, nonatomic, strong) OttuSentryObjCSpan *span;
